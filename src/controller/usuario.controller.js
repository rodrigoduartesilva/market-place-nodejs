...
const addUserAddressController = async (req, res) => {
    try {
        ...
        if (endereco.ok == 1) {
            ...
            res.status(200).send({ message: `Algo deu errado no endereço, tente novamente.` })
        }
...
const removeUserAddressController = async (req, res) => {
    try {
        ...
        if (endereco.ok == 1) {
            ...
            res.status(200).send({ message: `Algo deu errado no endereço, não foi removido, tente novamente.` })
        }
